      ...
      {connected ? (
        ...
        <>
          ...
          <p className="text-gray-600 text-center mb-8">
            Link your cryptocurrency wallet to manage bounties, receive
            payments, and track your earnings securely.
          </p>
          <motion.div
          ...
          <p className="text-xs text-gray-500 text-center mb-8">
            We support various wallet providers. Choose your preferred wallet on
            the next screen.
          </p>
        </>
      )}
